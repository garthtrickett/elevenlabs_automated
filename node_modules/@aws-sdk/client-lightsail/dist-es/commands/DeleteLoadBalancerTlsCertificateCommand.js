...
import { de_DeleteLoadBalancerTlsCertificateCommand, se_DeleteLoadBalancerTlsCertificateCommand, } from "../protocols/Aws_json1_1";
export class DeleteLoadBalancerTlsCertificateCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DeleteLoadBalancerTlsCertificateCommand.getEndpointParameterInstructions()));
