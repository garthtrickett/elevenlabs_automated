...
import { de_GetCloudFormationStackRecordsCommand, se_GetCloudFormationStackRecordsCommand, } from "../protocols/Aws_json1_1";
export class GetCloudFormationStackRecordsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetCloudFormationStackRecordsCommand.getEndpointParameterInstructions()));
