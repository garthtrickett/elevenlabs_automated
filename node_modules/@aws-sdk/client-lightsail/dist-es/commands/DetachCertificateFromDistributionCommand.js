...
import { de_DetachCertificateFromDistributionCommand, se_DetachCertificateFromDistributionCommand, } from "../protocols/Aws_json1_1";
export class DetachCertificateFromDistributionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DetachCertificateFromDistributionCommand.getEndpointParameterInstructions()));
