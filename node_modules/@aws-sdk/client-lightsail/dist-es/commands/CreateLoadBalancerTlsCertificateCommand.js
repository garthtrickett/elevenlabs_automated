...
import { de_CreateLoadBalancerTlsCertificateCommand, se_CreateLoadBalancerTlsCertificateCommand, } from "../protocols/Aws_json1_1";
export class CreateLoadBalancerTlsCertificateCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateLoadBalancerTlsCertificateCommand.getEndpointParameterInstructions()));
