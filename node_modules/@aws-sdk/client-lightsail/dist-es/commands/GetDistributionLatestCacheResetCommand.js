...
import { de_GetDistributionLatestCacheResetCommand, se_GetDistributionLatestCacheResetCommand, } from "../protocols/Aws_json1_1";
export class GetDistributionLatestCacheResetCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetDistributionLatestCacheResetCommand.getEndpointParameterInstructions()));
