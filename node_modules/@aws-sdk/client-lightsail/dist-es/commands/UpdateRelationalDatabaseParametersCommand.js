...
import { de_UpdateRelationalDatabaseParametersCommand, se_UpdateRelationalDatabaseParametersCommand, } from "../protocols/Aws_json1_1";
export class UpdateRelationalDatabaseParametersCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateRelationalDatabaseParametersCommand.getEndpointParameterInstructions()));
