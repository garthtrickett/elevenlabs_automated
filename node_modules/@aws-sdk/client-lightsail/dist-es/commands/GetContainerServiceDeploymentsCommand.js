...
import { de_GetContainerServiceDeploymentsCommand, se_GetContainerServiceDeploymentsCommand, } from "../protocols/Aws_json1_1";
export class GetContainerServiceDeploymentsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, GetContainerServiceDeploymentsCommand.getEndpointParameterInstructions()));
