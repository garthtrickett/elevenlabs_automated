...
import { de_AttachCertificateToDistributionCommand, se_AttachCertificateToDistributionCommand, } from "../protocols/Aws_json1_1";
export class AttachCertificateToDistributionCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, AttachCertificateToDistributionCommand.getEndpointParameterInstructions()));
