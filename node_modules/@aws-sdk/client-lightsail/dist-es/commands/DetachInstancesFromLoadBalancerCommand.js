...
import { de_DetachInstancesFromLoadBalancerCommand, se_DetachInstancesFromLoadBalancerCommand, } from "../protocols/Aws_json1_1";
export class DetachInstancesFromLoadBalancerCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, DetachInstancesFromLoadBalancerCommand.getEndpointParameterInstructions()));
