...
import { de_CreateContainerServiceDeploymentCommand, se_CreateContainerServiceDeploymentCommand, } from "../protocols/Aws_json1_1";
export class CreateContainerServiceDeploymentCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateContainerServiceDeploymentCommand.getEndpointParameterInstructions()));
