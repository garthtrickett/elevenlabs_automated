...
import { de_CreateContainerServiceRegistryLoginCommand, se_CreateContainerServiceRegistryLoginCommand, } from "../protocols/Aws_json1_1";
export class CreateContainerServiceRegistryLoginCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateContainerServiceRegistryLoginCommand.getEndpointParameterInstructions()));
