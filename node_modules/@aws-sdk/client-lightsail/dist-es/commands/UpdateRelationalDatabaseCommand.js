...
import { UpdateRelationalDatabaseRequestFilterSensitiveLog, } from "../models/models_1";
...
export class UpdateRelationalDatabaseCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateRelationalDatabaseCommand.getEndpointParameterInstructions()));
