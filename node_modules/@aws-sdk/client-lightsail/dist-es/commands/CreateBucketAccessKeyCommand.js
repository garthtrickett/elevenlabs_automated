...
import { CreateBucketAccessKeyResultFilterSensitiveLog, } from "../models/models_0";
...
export class CreateBucketAccessKeyCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateBucketAccessKeyCommand.getEndpointParameterInstructions()));
