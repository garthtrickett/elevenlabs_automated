...
import { de_UpdateInstanceMetadataOptionsCommand, se_UpdateInstanceMetadataOptionsCommand, } from "../protocols/Aws_json1_1";
export class UpdateInstanceMetadataOptionsCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, UpdateInstanceMetadataOptionsCommand.getEndpointParameterInstructions()));
