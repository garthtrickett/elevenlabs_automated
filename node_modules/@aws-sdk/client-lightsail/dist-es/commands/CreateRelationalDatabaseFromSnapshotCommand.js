...
import { de_CreateRelationalDatabaseFromSnapshotCommand, se_CreateRelationalDatabaseFromSnapshotCommand, } from "../protocols/Aws_json1_1";
export class CreateRelationalDatabaseFromSnapshotCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, CreateRelationalDatabaseFromSnapshotCommand.getEndpointParameterInstructions()));
