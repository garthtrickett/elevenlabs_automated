...
import { de_AttachInstancesToLoadBalancerCommand, se_AttachInstancesToLoadBalancerCommand, } from "../protocols/Aws_json1_1";
export class AttachInstancesToLoadBalancerCommand extends $Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use(getEndpointPlugin(configuration, AttachInstancesToLoadBalancerCommand.getEndpointParameterInstructions()));
