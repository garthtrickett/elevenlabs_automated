...
class GetRelationalDatabaseMasterUserPasswordCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, GetRelationalDatabaseMasterUserPasswordCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_json1_1_1.se_GetRelationalDatabaseMasterUserPasswordCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_json1_1_1.de_GetRelationalDatabaseMasterUserPasswordCommand)(output, context);
    }
}
